            ...
            <div className="flex items-center justify-between pt-2 border-t">
              <div className="flex items-center space-x-2 flex-wrap gap-2">
                ...
                {mainCandidate["qualifications"] !== null && mainCandidate["qualifications"] !== undefined && mainCandidate["qualifications"] !== "" ? (
                  <Badge className="border-2 border-green-600 text-green-600 dark:text-green-400 dark:border-green-400 bg-transparent shadow-md hover:shadow-lg transition-all duration-200">

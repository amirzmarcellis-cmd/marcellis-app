    ...
    <div className="min-h-screen bg-background text-foreground p-3 sm:p-4 md:p-6 w-full overflow-x-hidden">
      ...
      <Card className="bg-card border-border dark:bg-gradient-to-br dark:from-white/10 dark:to-white/5 dark:backdrop-blur-xl dark:border-white/20 shadow-2xl">
        ...
        <CardContent className="p-2 sm:p-4 md:p-6">
          <ScrollArea className="h-[500px] sm:h-[600px] pr-1 sm:pr-4">
            <div className="space-y-2 sm:space-y-4">
              {sortedCandidates.map((candidate, index) => {
                ...
                return (
                  <div 
                    key={index} 
                    className={`group relative p-2.5 sm:p-4 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl border transition-all duration-300 hover:shadow-xl cursor-pointer active:scale-[0.98] w-full max-w-full overflow-hidden
                  ...
                  >
                    ...
                    {/* Candidate Info */}
                    <div className="flex items-start gap-2 sm:gap-3 md:gap-4 mb-2 sm:mb-3 md:mb-4 pr-12 sm:pr-14 md:pr-20 w-full max-w-full">
                      <Avatar className="w-9 h-9 sm:w-12 sm:h-12 md:w-16 md:h-16 border-2 border-cyan-400/50 shrink-0">
                        <AvatarFallback className="bg-gradient-to-br from-cyan-500 to-purple-600 text-white text-xs sm:text-base md:text-lg font-bold">
                      ...
                      <div className="flex-1 min-w-0 max-w-full overflow-hidden">
                        ...
                        <div className="space-y-1.5 sm:space-y-2 text-[10px] sm:text-xs md:text-sm font-light font-inter w-full max-w-full">
                          ...
                          <div className="flex items-start gap-1 sm:gap-1.5 text-muted-foreground min-w-0 w-full">
                            ...
                            <span className="break-words flex-1 leading-tight">{candidate.candidate_phone_number}</span>
                          </div>
                          <div className="flex items-start gap-1 sm:gap-1.5 text-muted-foreground min-w-0 w-full">
                    ...
                    {/* Action Buttons */}
                    <div className="mt-2 sm:mt-3 md:mt-4 pt-2 sm:pt-3 md:pt-4 border-t border-border/20 w-full max-w-full">
                      <div className="flex items-center justify-end gap-1.5 sm:gap-2 md:gap-3 w-full">
                        <Button 
                          size="sm" 
                          variant="destructive" 
                          onClick={e => {
                          ...
                          className="bg-red-500 hover:bg-red-600 text-white border border-red-400 hover:border-red-300 h-7 sm:h-9 md:h-10 text-[10px] sm:text-xs md:text-sm px-2 sm:px-3 md:px-4 flex-1 sm:flex-none"
                        >
                          <XCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 sm:mr-1" />
                        ...
                        <Button 
                          ...
                          className="bg-green-500 hover:bg-green-600 text-white border border-green-400 hover:border-green-300 h-7 sm:h-9 md:h-10 text-[10px] sm:text-xs md:text-sm px-2 sm:px-3 md:px-4 flex-1 sm:flex-none"
                        >
                          <CheckCircle className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 sm:mr-1" />

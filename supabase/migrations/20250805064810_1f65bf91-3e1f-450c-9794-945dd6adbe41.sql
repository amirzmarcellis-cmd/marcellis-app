...
-- Add call logs and activity tracking tables (without role checks for now)
...
-- Basic RLS policies for call_logs
...
-- Basic RLS policies for activity_logs
...
CREATE POLICY "Authenticated users can view file uploads" 
ON public.file_uploads 
FOR SELECT 
USING (auth.uid() IS NOT NULL);

CREATE POLICY "Authenticated users can create file uploads" 
ON public.file_uploads 
FOR INSERT 
